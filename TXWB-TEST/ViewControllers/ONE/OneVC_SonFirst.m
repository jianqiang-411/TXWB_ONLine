...
- (void)viewDidLoad
{
    ...
    self.lblUserName = [[UILabel alloc] initWithFrame:CGRectMake(110, 2, 200, 40)];
...
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:@"转播成功" delegate:self cancelButtonTitle:@"确定" otherButtonTitles: nil];
    [alert show];
}
