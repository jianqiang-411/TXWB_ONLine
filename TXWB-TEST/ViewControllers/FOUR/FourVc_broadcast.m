...
@interface FourVc_broadcast () <PullingRefreshTableViewDelegate, UITableViewDataSource,UITableViewDelegate>
...
@implementation FourVc_broadcast
...
- (void)loadData
{
    ...
    NSURL* url = [NSURL URLWithString:@"https://open.t.qq.com/api/statuses/user_timeline"];
